...
export default function AdminLayout({
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
            {/* Sidebar */}
            <aside className={`
                w-full md:w-64 bg-white border-r border-gray-200 flex flex-col z-[50]
            ...
            `}>
                ...
                <div className="p-4 border-t border-gray-100 bg-white mt-auto">
                    <div className="mb-4 px-4">
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Yönetim Paneli</p>
                    </div>
                    <button
                    ...
                    <Link href="/" className="mt-2 flex items-center gap-3 px-4 py-2 text-primary hover:bg-primary/5 rounded-sm transition-colors text-[10px] font-bold uppercase tracking-tighter">
                        Mağazaya Git
                    </Link>
                </div>
            </aside>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                {/* Header */}
                <header className="h-16 bg-white border-b border-gray-200 px-4 md:px-8 flex items-center justify-between z-[40]">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="hidden md:block text-sm font-bold text-gray-400 uppercase tracking-widest underline decoration-primary decoration-2 underline-offset-8">Yönetim Paneli</h2>
                        <h2 className="md:hidden text-sm font-bold text-secondary">Admin</h2>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            {isAdminMenuOpen && (
                                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-sm shadow-2xl py-2 animate-in fade-in zoom-in duration-200 z-[100]">
                                    <div className="px-4 py-2 border-b border-gray-50 mb-1">
                                        <p className="text-[10px] text-gray-400 uppercase font-black">Admin Hesabı</p>
                                        <p className="text-xs font-bold truncate text-secondary">admin</p>
                                    </div>
